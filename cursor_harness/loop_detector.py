...
class LoopDetector:
    ...
    Detection methods:
    1. Repeated file reads (same files 3+ times)
    ...
    def __init__(self, max_repeated_reads: int = 3, session_timeout_minutes: int = 60):
        ...
        self.file_read_history = deque(maxlen=5)  # Last 5 sessions
    ...
    def check_repeated_file_reads(self) -> tuple[bool, str]:
        """
        Check if agent is reading same files repeatedly.
